 ...
 * @author Lenovo
 */
public class BuySharesController implements Initializable {

    @FXML
    private Label availableShares;
    @FXML
    private TextField sharesQuantity;
    @FXML
    private Button confirmButton;

    private String stocksQuant;
    private String companyName;

    public void setNumOfShares(String stocksQuant) {
        this.stocksQuant = stocksQuant;
    }
    ...
    public void buyShares() {
        availableShares.setText(stocksQuant);
    }
        ...
        if (file.exists()) {
            ...
            try {
                ...
                for (int i = 0; i < length; ++i) {
                    ...
                    //if name is same as companyName the put data
                    if (companyName.equalsIgnoreCase(name)) {
                        current.put("numOfShares", (num - quantity));
                        break;
                    }
                }
                //write the updated array back to the local shares file
                ...
                Logger.getLogger(BuySharesController.class.getName()).log(Level.SEVERE, null, ex);
